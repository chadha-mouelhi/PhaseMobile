...
public class HomeForm extends Form {
    ...
    public HomeForm() {
        ...
        Button btnListTest = new Button("Liste des Test");
        Button btnListTester = new Button("Mes Test");
    ...
    //   btnListCategorie.addActionListener(e -> new ListCategorieGui(current).show());
       btnListTest.addActionListener(e -> new ListTestGui(current).show());
        btnListTester.addActionListener(e -> new ListTesterGui(current).show());
        ...
        addAll(btnListTest,btnListTester );
