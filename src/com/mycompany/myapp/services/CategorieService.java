...
public class CategorieService {
    ...
    public boolean addCategorie(Categorie t) {
        String url = Statics.BASE_URL + "/addCategorie?nomcategorie=" + t.getNomcategorie() + "&description=" + t.getDescription(); //cr̩ation de l'URL
    ...
    public ArrayList<Categorie> getAllCategories(){
        String url = Statics.BASE_URL+"/articles/liste/";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
