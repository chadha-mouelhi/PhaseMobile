...
public class ServiceCategorie {
    ...
    public boolean addCategorie(Categorie t) {
        String url = Statics.BASE_URL + "/categorie/" + t.getId()+ "/" + t.getNomcategorie()+ "/" + t.getDescription(); //création de l'URL
        ...
        try {
            ...
            */
            ...
            for(Map<String,Object> obj : list){
                ...
                t.setId((int)id);
               // t.setNomcategorie(((int)Float.parseFloat(obj.get("nomcategorie").toString())));
