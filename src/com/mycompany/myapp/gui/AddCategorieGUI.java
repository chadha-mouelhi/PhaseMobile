        ...
        */
        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                if ((tfNomcategorie.getText().length()==0)||(tfDesc.getText().length()==0))
                    Dialog.show("Alert", "Please fill all the fields", new Command("OK"));
                else
                {
                    try {
                        Categorie t = new Categorie((tfNomcategorie.getText()), tfDesc.getText());
        ...
        addAll(tfNomcategorie,tfDesc,btnValider);
